...
p <- ggplot(data = m2test,aes(x=age,y=realleftcheekSER))+
  geom_point(pch=16, color="blue",size=1)+
  geom_smooth(method="loess",formula = y ~ x ,color="red",linetype=2,level=.95)+       
  labs(title ="m2", x="age", y="realSER")
...
p <- ggplot(data = w1test,aes(x=age,y=realleftcheekSER))+
  geom_point(pch=16, color="blue",size=1)+
  geom_smooth(method="loess",formula = y ~ x ,color="red",linetype=2,level=.95)+       
  labs(title ="w1", x="age", y="realSER")
...
p <- ggplot(data = w2test,aes(x=age,y=realleftcheekSER))+
  geom_point(pch=16, color="blue",size=1)+
  geom_smooth(method="loess",formula = y ~ x ,color="red",linetype=2,level=.95)+       
  labs(title ="w2", x="age", y="realSER")
...
p <- ggplot(data = htest,aes(x=age,y=realleftcheekSER))+
  geom_point(pch=16, color="blue",size=1)+
  geom_smooth(method="loess",formula = y ~ x ,color="red",linetype=2,level=.95)+       
  labs(title ="总", x="age", y="realSER")
...
p <- ggplot(data = mtest,aes(x=age,y=realleftcheekSER))+
  geom_point(pch=16, color="blue",size=1)+
  geom_smooth(method="loess",formula = y ~ x ,color="red",linetype=2,level=.95)+       
  labs(title ="m", x="age", y="realSER")
...
p <- ggplot(data = wtest,aes(x=age,y=realleftcheekSER))+
  geom_point(pch=16, color="blue",size=1)+
  geom_smooth(method="loess",formula = y ~ x ,color="red",linetype=2,level=.95)+       
  labs(title ="w", x="age", y="realSER")
